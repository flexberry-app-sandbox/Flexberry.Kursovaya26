...
namespace IIS.Kursovaya
{
    ...
    [MasterViewDefineAttribute("ТЧФактВыпРE", "СтатьиЗатрат", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Статья затрат")]
    ...
    [MasterViewDefineAttribute("ТЧФактВыпРE", "ТрСрКнтр", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Транспортное средство контрагента")]
    [MasterViewDefineAttribute("ТЧФактВыпРE", "СпрЕдИзмер", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Единица измерения")]
    public class ТЧФактВыпР : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya.ФактВыполРаб fФактВыполРаб;
        ...
        /// Т ч факт вып Р.
        /// </summary>
        // *** Start programmer edit section *** (ТЧФактВыпР.ТрСрКнтр CustomAttributes)

        // *** End programmer edit section *** (ТЧФактВыпР.ТрСрКнтр CustomAttributes)
        [PropertyStorage(new string[] {
                "ТрСрКнтр"})]
        [NotNull()]
        public virtual IIS.Kursovaya.ТрСрКнтр ТрСрКнтр
        {
            get
            {
                // *** Start programmer edit section *** (ТЧФактВыпР.ТрСрКнтр Get start)

                // *** End programmer edit section *** (ТЧФактВыпР.ТрСрКнтр Get start)
                IIS.Kursovaya.ТрСрКнтр result = this.fТрСрКнтр;
                // *** Start programmer edit section *** (ТЧФактВыпР.ТрСрКнтр Get end)

                // *** End programmer edit section *** (ТЧФактВыпР.ТрСрКнтр Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ТЧФактВыпР.ТрСрКнтр Set start)

                // *** End programmer edit section *** (ТЧФактВыпР.ТрСрКнтр Set start)
                this.fТрСрКнтр = value;
                // *** Start programmer edit section *** (ТЧФактВыпР.ТрСрКнтр Set end)

                // *** End programmer edit section *** (ТЧФактВыпР.ТрСрКнтр Set end)
            }
        }
        
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kursovaya.ФактВыполРаб.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ФактВыполРаб"})]
        public virtual IIS.Kursovaya.ФактВыполРаб ФактВыполРаб
        {
            get
            {
                ...
                IIS.Kursovaya.ФактВыполРаб result = this.fФактВыполРаб;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧФактВыпРE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧФактВыпРE", typeof(IIS.Kursovaya.ТЧФактВыпР));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧФактВыпР : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kursovaya.DetailArrayOfТЧФактВыпР members)

        // *** End programmer edit section *** (IIS.Kursovaya.DetailArrayOfТЧФактВыпР members)
        ...
        /// </summary>
        public DetailArrayOfТЧФактВыпР(IIS.Kursovaya.ФактВыполРаб fФактВыполРаб) : 
                base(typeof(ТЧФактВыпР), ((ICSSoft.STORMNET.DataObject)(fФактВыполРаб)))
        {
        }
        
        public IIS.Kursovaya.ТЧФактВыпР this[int index]
        {
            get
            {
                return ((IIS.Kursovaya.ТЧФактВыпР)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kursovaya.ТЧФактВыпР dataobject)
        {
