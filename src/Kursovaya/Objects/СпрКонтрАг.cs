    ...
    public class СпрКонтрАг : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СпрКонтрАгE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрКонтрАгE", typeof(IIS.Kursovaya.СпрКонтрАг));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СпрКонтрАгL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрКонтрАгL", typeof(IIS.Kursovaya.СпрКонтрАг));
                }
            }
        }
    }
