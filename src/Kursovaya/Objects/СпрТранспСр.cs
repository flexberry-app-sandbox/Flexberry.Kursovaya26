...
namespace IIS.Kursovaya
{
    ...
    public class СпрТранспСр : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya.СпрТипТрансСр fСпрТипТрансСр;
        ...
        /// Спр трансп ср.
        /// </summary>
        // *** Start programmer edit section *** (СпрТранспСр.СпрТипТрансСр CustomAttributes)

        // *** End programmer edit section *** (СпрТранспСр.СпрТипТрансСр CustomAttributes)
        [PropertyStorage(new string[] {
                "СпрТипТрансСр"})]
        [NotNull()]
        public virtual IIS.Kursovaya.СпрТипТрансСр СпрТипТрансСр
        {
            get
            {
                // *** Start programmer edit section *** (СпрТранспСр.СпрТипТрансСр Get start)

                // *** End programmer edit section *** (СпрТранспСр.СпрТипТрансСр Get start)
                IIS.Kursovaya.СпрТипТрансСр result = this.fСпрТипТрансСр;
                // *** Start programmer edit section *** (СпрТранспСр.СпрТипТрансСр Get end)

                // *** End programmer edit section *** (СпрТранспСр.СпрТипТрансСр Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (СпрТранспСр.СпрТипТрансСр Set start)

                // *** End programmer edit section *** (СпрТранспСр.СпрТипТрансСр Set start)
                this.fСпрТипТрансСр = value;
                // *** Start programmer edit section *** (СпрТранспСр.СпрТипТрансСр Set end)

                // *** End programmer edit section *** (СпрТранспСр.СпрТипТрансСр Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СпрТранспСрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрТранспСрE", typeof(IIS.Kursovaya.СпрТранспСр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СпрТранспСрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрТранспСрL", typeof(IIS.Kursovaya.СпрТранспСр));
                }
            }
        }
    }
