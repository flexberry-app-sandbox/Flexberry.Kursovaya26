...
(
	...
	"ВремПриб" NVARCHAR2(255) NULL,

	"КолЧас" FLOAT(53) NULL,

	"ТрСрКнтр" RAW(16) NOT NULL,
...
ALTER TABLE "ТЧПлЗНаД"
	ADD CONSTRAINT "ТЧПлЗНаД_FТрС_7903" FOREIGN KEY ("ТрСрКнтр") REFERENCES "ТрСрКнтр" ("primaryKey");

CREATE INDEX "ТЧПлЗНаД_IТрС_6988" on "ТЧПлЗНаД" ("ТрСрКнтр");
...
CREATE INDEX "ТрСрКнтр_IСпр_7741" on "ТрСрКнтр" ("СпрТранспСр");

ALTER TABLE "СпрТранспСр"
	ADD CONSTRAINT "СпрТранспСр_F_9850" FOREIGN KEY ("СпрТипТрансСр") REFERENCES "СпрТипТрансСр" ("primaryKey");

CREATE INDEX "СпрТранспСр_I_3281" on "СпрТранспСр" ("СпрТипТрансСр");
...
ALTER TABLE "ТЧФактВыпР"
	ADD CONSTRAINT "ТЧФактВыпР_FТ_4351" FOREIGN KEY ("ТрСрКнтр") REFERENCES "ТрСрКнтр" ("primaryKey");

CREATE INDEX "ТЧФактВыпР_IТ_6722" on "ТЧФактВыпР" ("ТрСрКнтр");
